...
<!--     <script src="<?php echo site_url(); ?>assets/js/line-chart.js"></script> -->
    <!-- all pie chart -->
<!--     <script src="<?php echo site_url(); ?>assets/js/pie-chart.js"></script>
 -->
    ...
    <script src="<?php echo site_url(); ?>assets/datepicker/bootstrap-datetimepicker.min.js"></script>
