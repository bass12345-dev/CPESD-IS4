<div class="modal fade" id="update_officer_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="modal-content">
         ...
         <form id="update_officer_form" class="p-2">
            ...
            <div class="form-group">
                  ...
                  <select class="custom-select"  name="update_cso_position" style="border: 1px solid;height: 45px;" required>
